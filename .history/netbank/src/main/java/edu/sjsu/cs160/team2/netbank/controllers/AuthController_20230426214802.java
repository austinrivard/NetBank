...
public class AuthController {
    ...
    public ResponseEntity<String> verifyToken(@RequestBody String idToken) {
        try {
            ...
            User u = userRepository.findByUid(decodedToken.getUid()).orElseThrow(() -> new UsernameNotFoundException("User not found"));
            return ResponseEntity.ok(u.getUid());
        } catch (FirebaseAuthException | IllegalArgumentException e | UsernameNotFoundException e) {
